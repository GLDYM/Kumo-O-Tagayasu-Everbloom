...
import { $InteractMaidEventJS, $MaidTaskEnableEventJS, $MaidHurtEventJS, $MaidPickupEventJS$PowerPointResult, $MaidTickEventJS, $MaidPickupEventJS$ItemResultPre, $MaidEquipEventJS, $MaidDeathEventJS, $MaidAfterEatEventJS, $MaidFishedEventJS, $MaidTamedEventJS, $MaidPlaySoundEventJS, $MaidAttackEventJS, $MaidDamageEventJS, $MaidPickupEventJS$ArrowResult, $MaidPickupEventJS$ItemResultPost, $AddTopInfoEventJS, $MaidPickupEventJS$ExperienceResult, $AddJadeInfoEventJS } from "@package/com/github/tartaricacid/touhoulittlemaid/compat/kubejs/event/common";
...
declare global {
    ...
    namespace MaidEvents {
        function maidPickupPowerPointResult(handler: ((event: $MaidPickupEventJS$PowerPointResult) => void)): void;
        function addTopInfo(handler: ((event: $AddTopInfoEventJS) => void)): void;
        function maidTamed(handler: ((event: $MaidTamedEventJS) => void)): void;
        function interactMaid(extra: $ResourceKey_<$Item>, handler: ((event: $InteractMaidEventJS) => void)): void;
        function interactMaid(handler: ((event: $InteractMaidEventJS) => void)): void;
        function maidPickupExperienceResult(handler: ((event: $MaidPickupEventJS$ExperienceResult) => void)): void;
        function maidPickupArrowResult(handler: ((event: $MaidPickupEventJS$ArrowResult) => void)): void;
        function maidEquip(extra: $ResourceKey_<$Item>, handler: ((event: $MaidEquipEventJS) => void)): void;
        function maidEquip(handler: ((event: $MaidEquipEventJS) => void)): void;
        function maidFished(handler: ((event: $MaidFishedEventJS) => void)): void;
        function maidPickupItemResultPre(handler: ((event: $MaidPickupEventJS$ItemResultPre) => void)): void;
        function maidAfterEat(extra: $ResourceKey_<$Item>, handler: ((event: $MaidAfterEatEventJS) => void)): void;
        function maidAfterEat(handler: ((event: $MaidAfterEatEventJS) => void)): void;
        function maidDamage(extra: $ResourceLocation_, handler: ((event: $MaidDamageEventJS) => void)): void;
        function maidDamage(handler: ((event: $MaidDamageEventJS) => void)): void;
        function maidDeath(extra: $ResourceLocation_, handler: ((event: $MaidDeathEventJS) => void)): void;
        function maidDeath(handler: ((event: $MaidDeathEventJS) => void)): void;
        function maidHurt(extra: $ResourceLocation_, handler: ((event: $MaidHurtEventJS) => void)): void;
        function maidHurt(handler: ((event: $MaidHurtEventJS) => void)): void;
        function maidAttack(extra: $ResourceLocation_, handler: ((event: $MaidAttackEventJS) => void)): void;
        function maidAttack(handler: ((event: $MaidAttackEventJS) => void)): void;
        function maidPlaySound(handler: ((event: $MaidPlaySoundEventJS) => void)): void;
        function addJadeInfo(handler: ((event: $AddJadeInfoEventJS) => void)): void;
        function maidTaskEnable(extra: $ResourceLocation_, handler: ((event: $MaidTaskEnableEventJS) => void)): void;
        function maidTaskEnable(handler: ((event: $MaidTaskEnableEventJS) => void)): void;
        function maidTick(handler: ((event: $MaidTickEventJS) => void)): void;
        function maidPickupItemResultPost(handler: ((event: $MaidPickupEventJS$ItemResultPost) => void)): void;
    }
