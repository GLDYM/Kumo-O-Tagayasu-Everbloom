...
import { $KJSCraftEvent } from "@package/studio/fantasyit/maid_storage_manager/integration/kubejs/event";
...
declare global {
    namespace MaidStorageManagerEvents {
        function craft(handler: ((event: $KJSCraftEvent) => void)): void;
    }
