...
declare module "@package/net/minecraft" {
    ...
    export class $SystemReport implements $SystemReportAccessor {
        ...
        static getJAVA_VERSION$create_$md$70d283$3(): string;
        static getOPERATING_SYSTEM$create_$md$70d283$2(): string;
        ...
        constructor();
        static get JAVA_VERSION$create_$md$70d283$3(): string;
        static get OPERATING_SYSTEM$create_$md$70d283$2(): string;
