...
import { $IMixinDebugRenderer } from "@package/fi/dy/masa/minihud/mixin/debug";

declare module "@package/net/minecraft/client/renderer/debug" {
    export class $LightSectionDebugRenderer$SectionData {
    }
    export class $DebugRenderer implements $IMixinDebugRenderer {
        clear(): void;
        render(arg0: $PoseStack, arg1: $MultiBufferSource$BufferSource, arg2: number, arg3: number, arg4: number): void;
        handler$hai000$moonlight$supp$renderVanillaDebug(arg0: $PoseStack, arg1: $MultiBufferSource$BufferSource, arg2: number, arg3: number, arg4: number, arg5: $CallbackInfo): void;
