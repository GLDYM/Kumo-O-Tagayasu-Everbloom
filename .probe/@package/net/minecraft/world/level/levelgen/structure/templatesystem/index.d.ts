...
import { $StructureTemplateManagerAccessor, $TemplateAccessor, $StructureProcessorAccessor } from "@package/com/craisinlord/integrated_api/mixins/structures";
...
declare module "@package/net/minecraft/world/level/levelgen/structure/templatesystem" {
    ...
    export class $StructureTemplate implements $TemplateAccessor {
    ...
    export class $StructureTemplateManager implements $StructureTemplateManagerAccessor {
