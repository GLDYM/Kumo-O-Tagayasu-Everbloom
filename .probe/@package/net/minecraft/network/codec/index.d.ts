...
import { $UnaryOperator_, $IntFunction_, $Supplier_, $Function_, $BiFunction_, $Function, $ToIntFunction_ } from "@package/java/util/function";
...
declare module "@package/net/minecraft/network/codec" {
    ...
    export interface $StreamCodec extends RegistryMarked<RegistryTypes.SupplementariesSlotReferenceTypeTag, RegistryTypes.SupplementariesSlotReferenceType> {}
    ...
    export class $IdDispatchCodec<B extends $ByteBuf, V, T> implements $StreamCodec<B, V> {
        ...
        toId: $Object2IntMap<V>;
        typeGetter: $Function<V, V>;
