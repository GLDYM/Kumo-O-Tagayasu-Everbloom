...
declare module "@package/net/neoforged/fml" {
     ...
     */
    export type $ModLoadingIssue_ = { translationArgs?: $List_<$Object>, translationKey?: string, cause?: $Throwable, affectedMod?: $IModInfo, affectedPath?: $Path_, affectedModFile?: $IModFile, severity?: $ModLoadingIssue$Severity_,  } | [translationArgs?: $List_<$Object>, translationKey?: string, cause?: $Throwable, affectedMod?: $IModInfo, affectedPath?: $Path_, affectedModFile?: $IModFile, severity?: $ModLoadingIssue$Severity_, ];
     ...
     */
    export type $InterModComms$IMCMessage_ = { senderModId?: string, method?: string, messageSupplier?: $Supplier_<never>, modId?: string,  } | [senderModId?: string, method?: string, messageSupplier?: $Supplier_<never>, modId?: string, ];
