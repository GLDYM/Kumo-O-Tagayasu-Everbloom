...
import { $ImmunityDataExtra, $ImmunityData } from "@package/dev/xkmc/l2damagetracker/contents/immunity";
...
declare module "@package/net/neoforged/neoforge/event/entity" {
    ...
    export class $EntityInvulnerabilityCheckEvent extends $EntityEvent implements $ImmunityDataExtra {
        getSource(): $DamageSource;
        getOriginalInvulnerability(): boolean;
        isInvulnerable(): boolean;
        setInvulnerable(arg0: boolean): void;
        l2damagetracker$getExtra(): $ImmunityData;
        handler$eoo000$l2damagetracker$setInvulnerable$log(arg0: boolean, arg1: $CallbackInfo): void;
