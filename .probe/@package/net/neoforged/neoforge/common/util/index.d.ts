...
import { $Comparator, $Map, $Map$Entry, $Set, $ListIterator, $Spliterator, $Iterator, $Properties, $List, $SequencedCollection, $Collection_, $List_, $SequencedSet } from "@package/java/util";
