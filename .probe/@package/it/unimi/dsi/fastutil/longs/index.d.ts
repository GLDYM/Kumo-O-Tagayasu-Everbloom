...
declare module "@package/it/unimi/dsi/fastutil/longs" {
    ...
    export class $Long2BooleanMap$Entry {
    }
    export interface $Long2BooleanMap$Entry extends $Map$Entry<number, boolean> {
        /**
         * @deprecated
         */
        getValue(): boolean;
    ...
    export interface $Long2BooleanMap extends $Long2BooleanFunction, $Map<number, boolean> {
         ...
         */
        containsKey(arg0: $Object): boolean;
        computeIfAbsent(arg0: number, arg1: $LongPredicate_$1): boolean;
        computeIfAbsent(arg0: number, arg1: $Long2BooleanFunction_): boolean;
         ...
         * @deprecated
         */
        computeIfAbsentPartial(arg0: number, arg1: $Long2BooleanFunction_): boolean;
        computeIfAbsentNullable(arg0: number, arg1: $LongFunction_<boolean>): boolean;
        long2BooleanEntrySet(): $ObjectSet<$Long2BooleanMap$Entry>;
        remove(arg0: number): boolean;
        get(arg0: number): boolean;
