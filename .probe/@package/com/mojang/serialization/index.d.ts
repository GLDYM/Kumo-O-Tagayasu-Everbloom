...
declare module "@package/com/mojang/serialization" {
    ...
    export interface $MapCodec extends RegistryMarked<RegistryTypes.EnchantmentValueEffectTypeTag, RegistryTypes.EnchantmentValueEffectType> {}
     ...
     */
    export type $MapCodec_<A> = RegistryTypes.EnchantmentLevelBasedValueType | RegistryTypes.LithostitchedBiomeInjectorType | RegistryTypes.LithostitchedLoadPredicateType | RegistryTypes.ObscureTooltipsLabelProviderType | RegistryTypes.CreatePotatoProjectileRenderMode | RegistryTypes.NeoforgeGlobalLootModifierSerializers | RegistryTypes.MoonlightVillagerTrades | RegistryTypes.ObscureTooltipsTooltipEffectType | RegistryTypes.CreatePotatoProjectileEntityHitAction | RegistryTypes.BagusLibDialogType | RegistryTypes.WorldgenDensityFunctionType | RegistryTypes.ObscureTooltipsTooltipFrameType | RegistryTypes.NeoforgeConditionCodecs | RegistryTypes.FunctionalstorageFunctionalUpgradeBehavior | RegistryTypes.WorldgenMaterialRule | RegistryTypes.LithostitchedModifierType | RegistryTypes.LithostitchedProcessorConditionType | RegistryTypes.NeoforgeStructureModifierSerializers | RegistryTypes.LithostitchedFastNoiseConfigType | RegistryTypes.ObscureTooltipsTooltipIconType | RegistryTypes.EnchantmentProviderType | RegistryTypes.CreatePotatoProjectileBlockHitAction | RegistryTypes.WorldgenMaterialCondition | RegistryTypes.ObscureTooltipsTooltipParticleType | RegistryTypes.ObscureTooltipsTooltipSlotType | RegistryTypes.LithostitchedPlacementConditionType | RegistryTypes.LithostitchedBandlandsBandType | RegistryTypes.ObscureTooltipsTooltipLayoutType | RegistryTypes.EntitySubPredicateType | RegistryTypes.EnchantmentEntityEffectType | RegistryTypes.WorldgenPoolAliasBinding | RegistryTypes.ObscureTooltipsItemFilterType | RegistryTypes.EnchantmentLocationBasedEffectType | RegistryTypes.NeoforgeBiomeModifierSerializers | RegistryTypes.WorldgenChunkGenerator | RegistryTypes.BlockType | RegistryTypes.WorldgenBiomeSource | RegistryTypes.ObscureTooltipsTooltipPanelType | RegistryTypes.EnchantmentValueEffectType;
