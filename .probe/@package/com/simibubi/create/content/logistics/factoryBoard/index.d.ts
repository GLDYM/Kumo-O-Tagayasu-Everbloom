...
import { $Self, $OutlineRenderable } from "@package/io/github/forgestove/create_cyber_goggles/core/api";
import { $IPromiseLimit } from "@package/dev/khloeleclair/create/additionallogistics/common/utilities";
...
declare module "@package/com/simibubi/create/content/logistics/factoryBoard" {
    export class $FactoryPanelBlockEntity extends $SmartBlockEntity implements $OutlineRenderable, $Self<any> {
        getShape(): $VoxelShape;
        ccg$render(): void;
    ...
    export class $FactoryPanelBehaviour extends $FilteringBehaviour implements $MenuProvider, $IPromiseLimit, $IFluidPromiseLimit, $IFluidAdditionalStock, $IFluidRestockThreshold {
        ...
        setCALPromiseLimit(arg0: number): void;
        getCALPromiseLimit(): number;
        fluidlogistics$getRemainingAdditionalStock(): number;
        getCALAdditionalStock(): number;
        setCALAdditionalStock(arg0: number): void;
