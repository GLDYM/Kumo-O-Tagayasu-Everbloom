import { $Serializable, $InputStream, $IOException, $OutputStream, $Closeable } from "@package/java/io";
import { $Stream } from "@package/java/util/stream";
import { $Permission } from "@package/java/security";
import { $Enum, $Class, $Comparable, $Object } from "@package/java/lang";
import { $Enumeration, $List, $Map_, $List_, $Map, $Set } from "@package/java/util";
import { $ServerSocketChannel, $DatagramChannel, $SocketChannel } from "@package/java/nio/channels";
...
declare module "@package/java/net" {
    ...
    export class $CookieHandler {
        get(arg0: $URI, arg1: $Map_<string, $List_<string>>): $Map<string, $List<string>>;
        put(arg0: $URI, arg1: $Map_<string, $List_<string>>): void;
