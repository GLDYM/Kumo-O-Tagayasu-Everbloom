...
import { $Spliterator, $Iterator, $Queue, $Enumeration, $List, $Map_, $Collection_, $Collection, $Deque, $AbstractMap, $Map, $Map$Entry, $Set, $AbstractQueue } from "@package/java/util";
...
declare module "@package/java/util/concurrent" {
    ...
    export class $LinkedBlockingDeque<E> extends $AbstractQueue<E> implements $BlockingDeque<E>, $Serializable {
        put(arg0: E): void;
        getFirst(): E;
        getLast(): E;
        ...
        push(arg0: E): void;
        pop(): E;
        pollFirst(arg0: number, arg1: $TimeUnit_): E;
        pollFirst(): E;
        pollLast(arg0: number, arg1: $TimeUnit_): E;
        pollLast(): E;
        offerLast(arg0: E): boolean;
        offerLast(arg0: E, arg1: number, arg2: $TimeUnit_): boolean;
        peekFirst(): E;
        removeFirstOccurrence(arg0: $Object): boolean;
        offerFirst(arg0: E, arg1: number, arg2: $TimeUnit_): boolean;
