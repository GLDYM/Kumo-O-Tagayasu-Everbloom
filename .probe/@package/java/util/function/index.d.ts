...
declare module "@package/java/util/function" {
     ...
     */
    export type $Supplier_<T> = RegistryTypes.IntegratedApiJsonConditions | (() => T);
    ...
    export interface $Supplier extends RegistryMarked<RegistryTypes.IntegratedApiJsonConditionsTag, RegistryTypes.IntegratedApiJsonConditions> {}
