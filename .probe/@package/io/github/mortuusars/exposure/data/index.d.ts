...
declare module "@package/io/github/mortuusars/exposure/data" {
     ...
     */
    export type $Filter_ = RegistryTypes.ExposureFilter | { attachmentTintColor?: $Color_, predicate?: $ItemPredicate_, attachmentTexture?: $ResourceLocation_, shader?: $ResourceLocation_,  } | [attachmentTintColor?: $Color_, predicate?: $ItemPredicate_, attachmentTexture?: $ResourceLocation_, shader?: $ResourceLocation_, ];
