...
declare module "@package/dev/latvian/mods/kubejs/client/highlight" {
     ...
     */
    export type $HighlightRenderer$WrappedVertexConsumer_ = { red?: number, blue?: number, green?: number, delegate?: $VertexConsumer,  } | [red?: number, blue?: number, green?: number, delegate?: $VertexConsumer, ];
     ...
     */
    export type $HighlightRenderer$WrappedMultiBufferSource_ = { red?: number, blue?: number, green?: number, delegate?: $MultiBufferSource_,  } | [red?: number, blue?: number, green?: number, delegate?: $MultiBufferSource_, ];
}
