...
import { $FallingBlock, $Rotation_, $PressurePlateBlock, $EntityBlock, $Mirror_, $CropBlock, $SimpleWaterloggedBlock, $Block } from "@package/net/minecraft/world/level/block";
