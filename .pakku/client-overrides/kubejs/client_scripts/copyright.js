WeDoCopyRightEvents.addPage(event => {
  event.add(
    "Kumo O Tagayasu Everbloom 整合包在 AGPL-v3-or-later 许可证下发布。",
    "Copyright © 2026 北辰星光 & 浅忆星名",
    "",
    "\u00a7b你被允许做的，但需要保留作者、原作信息：",
    " 1. 使用本整合包进行视频制作等多媒体创作并获利。",
    " 2. 将整合包进行转载、存储、供其他玩家下载或开设服务器。",
    " 3. 二次修改整合包，将已被修改的整合包进行分发或开设服务器。",
    "    但你必须公开经过修改的整合包（包括服务端），并以相同协议分发。",
    "",
    "\u00a7b你被禁止做的：",
    " 1. 二次修改整合包分发或开设服务器，但不以相同协议公开修改内容。",
    " 2. 售卖本整合包以获利。",
    " 3. 未经授权将本整合包与资源包上传至其他平台，以获取平台的利益。"
  )
  event.add(
    "Kumo O Tagayasu Everbloom is published under AGPL-v3-or-later License.",
