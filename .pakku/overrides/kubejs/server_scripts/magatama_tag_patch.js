ServerEvents.tags('item', event => {
  event.add('c:raw_meats', [
    ...
    'kaleidoscope_end:raw_endermite_meat',
  ...
  event.add('c:fruits', [
    ...
    'delighto_flight:cloud_berries',
    'delighto_flight:copper_thunder_fruit',
    'delighto_flight:thunder_fruit',
